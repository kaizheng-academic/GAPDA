...
for ii in range(5):
    ...
    A, X, Y_train, Y_val, Y_test, idx_train, idx_val, idx_test = load_data(ii)
...
<<<<<<< HEAD
    y_prob=y_pred[idx_test][:,1]
    y_pred=y_pred[idx_test][:,1].round(decimals=0)
    y_label=Y_test[idx_test][:,1]
=======
n_classes = Y_train.shape[1]  # Number of classes
F_ = 8                        # Output size of first GraphAttention layer
n_attn_heads = 8              # Number of attention heads in first GAT layer
...
print('Done.\n'
      'Test loss: {}\n'
      'Test accuracy: {}'.format(*eval_results))
>>>>>>> 2919378dbf3e9ec94209d71629117c013c3fa163
